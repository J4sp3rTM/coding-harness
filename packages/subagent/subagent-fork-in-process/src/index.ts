...
/**
 * The fork provider. Supports `depthLimit`, `outputSchema` (via the shared
 * in-process structured runtime), `agentOptions`, and `toolFilter`/`persona`
 * (scoped restrict() and a scoped shadowing persona section).
 */
