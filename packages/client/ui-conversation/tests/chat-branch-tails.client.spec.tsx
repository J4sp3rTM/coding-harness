...
describe('MessageItem arms', () => {
  ...
  it('collapses retry details behind the durable model retry status', () => {
    ...
    expect(details?.textContent).toContain('Retry delay: 2500ms')
    expect(details?.textContent).toContain('Failure reason: connection reset')
    ...
    view.rerender(
      <MessageItem t={t} node={{
        ...
        retry: 3,
        delayMs: 3_500.4,
        failure: { code: 'TRANSPORT', message: 'continue retrying' },
      }}
      />,
    )
