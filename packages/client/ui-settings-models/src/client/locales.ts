...
export const en = {
  ...
  tierTitle: 'Development agent tiers',
  tierIntro: 'The parent/session model remains selected in the composer. These routes apply only to delegated work and review.',
  tierUnavailableSettings: 'Development tier settings are unavailable in this deployment.',
  tierCatalogError: 'The model catalog could not be loaded',
  tierUnavailable: 'unavailable',
  tierInherit: 'Inherit parent model',
  tierEffort: 'Reasoning effort',
  tierEffortDefault: 'Provider default effort',
  tierT1: 'T1 — Exceptional review',
  tierT1Help: 'Use for frontier or exceptional review; it only escalates delegated review.',
  tierT2: 'T2 — Implementation and inspection',
  tierT2Help: 'Use for ordinary implementation, inspection, and validation.',
  tierT3: 'T3 — Simple and low-risk',
  tierT3Help: 'Use for simple, repetitive, and low-risk work.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  tierTitle: '开发 agent 分级',
  tierIntro: '父级／会话模型仍在编排器中选择。这些路由只用于委派工作和审查。',
  tierUnavailableSettings: '当前部署无法使用开发分级设置。',
  tierCatalogError: '无法加载模型目录',
  tierUnavailable: '不可用',
  tierInherit: '继承父级模型',
  tierEffort: '推理等级',
  tierEffortDefault: '提供方默认推理等级',
  tierT1: 'T1 —— 特殊审查',
  tierT1Help: '用于 frontier 或特殊审查；只会提升委派的审查工作。',
  tierT2: 'T2 —— 实现与检查',
  tierT2Help: '用于普通实现、检查和验证。',
  tierT3: 'T3 —— 简单且低风险',
  tierT3Help: '用于简单、重复且低风险的工作。',
  tierSaved: '开发 agent 分级已保存。',
  tierApply: '保存分级',
  tierApplying: '正在保存分级……',
}
