...
import { accessEn, en, type PermissionAccessKey } from './locales.ts'
import {
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface LocaleNamespaceMap {
    /** Current-session popup-gate copy (the safety confirmation). */
...
function optionsOf(value: PermissionSelect, t: TranslateNS<'permission.access'>): SelectOption[] {
