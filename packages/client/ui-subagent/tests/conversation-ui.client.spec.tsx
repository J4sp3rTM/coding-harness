...
const t: SubagentCatalogActionProps['t'] = makeTranslate(en, commonEn)
...
describe('SubagentCatalogAction', () => {
  ...
  it('shows durable token totals, ticks active duration by seconds, and freezes inactive rows', async () => {
    ...
    expect(within(screen.getByRole('treeitem', { name: /days/ })).getByText('12d 5h').getAttribute('title')).toBe('Total active duration: 12d 05h 06m 07s')
