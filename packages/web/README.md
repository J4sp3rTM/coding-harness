...
| [`web-search-duckduckgo/`](web-search-duckduckgo/README.md) | Provides keyless DuckDuckGo HTML search | registers on `ctx.web` |
...
The subsystem reference — search/fetch requests and results, availability, `WebError` — is [docs/subsystems/web.md](../../docs/subsystems/web.md); provider-selection rationale in the [web capability seam Agent Note](../../.agents/notes/implemented/architecture/2026-06-24-web-capability-seam.md); the fetch provider's private-network guard scope in its [README](web-fetch-http/README.md) and [SSRF Agent Note](../../.agents/notes/implemented/architecture/2026-08-25-web-fetch-private-network-guard.md).
