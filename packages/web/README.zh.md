...
| [`web-search-duckduckgo/`](web-search-duckduckgo/README.md) | 提供无需密钥的 DuckDuckGo HTML 搜索 | 注册到 `ctx.web` |
...
子系统参考——搜索/抓取请求与结果、可用性、`WebError`——见 [docs/subsystems/web.md](../../docs/subsystems/web.md)；提供方选择原理见 [web 能力 seam Agent Note](../../.agents/notes/implemented/architecture/2026-06-24-web-capability-seam.md)；抓取提供方的私有网络防护范围见其 [README](web-fetch-http/README.md) 与 [SSRF Agent Note](../../.agents/notes/implemented/architecture/2026-08-25-web-fetch-private-network-guard.md)。
