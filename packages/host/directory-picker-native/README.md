...
On Windows, the dialog child decodes shell paths through koffi's NUL-terminated UTF-16 decoder, keeps IPC connected through the terminal result, and is terminated by the driver after settlement; parent disconnects and aborts cannot leave a modal child behind.
