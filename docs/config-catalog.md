...
Requires: `commands` · `systemPrompt`
...
Source: [`packages/context/command-rat/src/index.ts:36`](../packages/context/command-rat/src/index.ts)
...
Source: [`packages/llm/llm-oauth-local/src/index.ts:51`](../packages/llm/llm-oauth-local/src/index.ts)
...
Source: [`packages/llm/llm-pi-ai/src/config.ts:198`](../packages/llm/llm-pi-ai/src/config.ts)
...
- `@deepseek-ai/dsh-llm-oauth` — abstract `LlmOAuthService` ([`packages/llm/llm-oauth/src/index.ts`](../packages/llm/llm-oauth/src/index.ts))
