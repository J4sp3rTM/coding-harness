...
| [llm-streaming.md](llm-streaming.md) | the `packages/llm` conversation and authentication types — `Message`/`ContentBlock`, assembled requests, streaming, the adapter contract, and subscription sign-in |
