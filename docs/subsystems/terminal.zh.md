...
PTY 后端、`ctx.terminals` 与面向模型的消费方共享的类型。持久 PTY Agent Note 负责记录决策依据；本页记录来自 [`packages/terminal/terminal/src/types.ts`](../../packages/terminal/terminal/src/types.ts) 的跨包词汇。
