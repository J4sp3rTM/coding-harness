...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  deepseekAccount: 'llm-streaming.md',
  ...
  llmRetry: 'llm-streaming.md',
  llmOAuth: 'llm-streaming.md',
  lsp: 'lsp.md',
  messageFeedback: 'feedback.md',
  permissionPresets: 'permission-presets.md',
  planMode: 'plan.md',
  providerStatus: 'llm-streaming.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LlmOAuthAccount: 'llm-streaming.md',
  LlmOAuthInteraction: 'llm-streaming.md',
  LlmOAuthProviderInfo: 'llm-streaming.md',
  LlmOAuthTokenStore: 'llm-streaming.md',
  ResolvedRetryPolicy: 'llm-streaming.md',
  RequestRetryContributor: 'llm-streaming.md',
  ...
  ProviderPlanWindowSnapshot: 'llm-streaming.md',
  ProviderQuotaDimensionSnapshot: 'llm-streaming.md',
  ProviderStatusPublication: 'llm-streaming.md',
  ProviderStatusRecord: 'llm-streaming.md',
